            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    @if(is_default_lang())
                        ...
                        <a data-bs-toggle="tab" href="#nav-availability" aria-selected="false">{{__("4. Availability")}}</a>
                        <a data-bs-toggle="tab" href="#nav-attribute" aria-selected="false">{{__("5. Attributes")}}</a>
                        <a data-bs-toggle="tab" href="#nav-ical" aria-selected="false">{{__("6. Ical")}}</a>
                    @endif
                </div>
