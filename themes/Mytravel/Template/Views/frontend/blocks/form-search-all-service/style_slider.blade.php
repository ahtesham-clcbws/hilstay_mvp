                    ...
                    @if(!empty($service_types))
                        ...
                        @foreach ($service_types as $service_type)
                            ...
                            <li class="nav-item" role="bravo_{{$service_type}}">
                                <a class="nav-link font-weight-medium @if($number == 0) active @endif pl-md-5 pl-3" id="bravo_{{$service_type}}-tab" e="pill" href="#bravo_{{$service_type}}" role="tab" aria-controls="bravo_{{$service_type}}" aria-selected="true">
