                    ...
                    <form action="{{ route('review.store')}}" class="needs-validation sfeedbacks_form" novalidate method="post">
                        ...
                        <div class="row mb-5 mb-lg-0">
                            ...
                            <div class="col d-flex justify-content-center justify-content-lg-start">
                                <button type="submit" id="submit" name="submit" class="btn rounded-xs btn-primary text-white p-2 height-51 width-190 transition-3d-hover">{{__("Leave a Review")}}</button>
