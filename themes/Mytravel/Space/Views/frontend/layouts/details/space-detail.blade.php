    ...
    <ul class="list-group list-group-borderless list-group-horizontal flex-center-between text-center mx-md-4 flex-wrap">
        @if($row->bedroom)
            <li class="list-group-item text-lh-sm ">
                <svg xmlns="http://www.w3.org/2000/svg" class="text-primary font-size-50 mb-1 d-block" viewBox="0 0 32 32" width="86" height="62"><path d="M29.5 6h-2.793L24.85 4.143a1.5 1.5 0 1 0-2.7 0L20.293 6H17.5a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5zm-6-3a.5.5 0 1 1-.5.5.5.5 0 0 1 .5-.5zm-.643 1.85a1.453 1.453 0 0 0 1.286 0L25.293 6h-3.586zM29 7v3.293l-1.146-1.147a.5.5 0 0 0-.708 0L24.5 11.793l-2.646-2.647a.5.5 0 0 0-.708 0L18 12.293V7zm-11 6.707 3.5-3.5L25.293 14H18zm8.707.293-1.5-1.5 2.293-2.293 1.5 1.5V14z"/><circle cx="24.5" cy="8.5" r=".5"/><path d="M29.5 29H28v-7.5a4.505 4.505 0 0 0-4.5-4.5H10v-2.5A2.5 2.5 0 0 0 7.5 12H7V9.5a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 0-.5.5V29H2.5a.5.5 0 0 0 0 1h27a.5.5 0 0 0 0-1zM27 21.5V25H7v-7h16.5a3.5 3.5 0 0 1 3.5 3.5zM7 26h18v3H7zm.5-13A1.5 1.5 0 0 1 9 14.5V17H7v-4zM5 29V10h1v19zm21 0v-3h1v3z"/></svg>
                <div class="text-gray-1"> {{$row->bedroom}} {{ __("Bedroom") }}</div>
            </li>
        @endif
        <li class="list-group-item text-lh-sm ">
            <svg class="text-primary font-size-50 mb-1 d-block" width="86" height="62" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        @if($row->bathroom)
            <li class="list-group-item text-lh-sm ">
                ...
                <div class="text-gray-1"> {{$row->bathroom}} {{ __("Bathroom") }}</div>
            </li>
        @endif
        @if(!empty($row->bed))
            <li class="list-group-item text-lh-sm ">
