                            ...
                            <div class="border-0">
                                ...
                                <div id="attr_more_{{$item->id}}" class="collapse show" aria-labelledby="cityCategoryHeadingOne" data-parent="#attr_{{$item->id}}">
                                    <div class="card-body pt-0 mt-1  pb-4">
                                        ...
                                        <a class="link link-collapse small font-size-1 mt-2" data-bs-toggle="collapse" href="#more_term_{{$term->id}}" role="button" aria-expanded="false" aria-controls="more_term_{{$term->id}}">
